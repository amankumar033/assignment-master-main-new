...
const Toast: React.FC<ToastProps> = ({ type, message, onClose, duration = 4000 }) => {
  ...
  return (
    <div className={`fixed top-4 right-4 z-50 max-w-sm w-full rounded-lg p-4 ${getToastStyles().container} transform transition-all duration-75 ease-out animate-slide-in-fast`}>
