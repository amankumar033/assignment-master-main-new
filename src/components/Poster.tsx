...
export default function Poster() {
  ...
  return (
    <div className="mt-6 sm:mt-10 bg-white">
      <div className="bg-[url('/car-bg.png')] bg-cover bg-center w-full h-[300px] sm:h-[450px] flex flex-col sm:flex-row items-center px-4 sm:px-30">
        ...
        <div className="w-full sm:w-1/2 text-white text-center sm:text-left">
          ...
          <button className="bg-white hover:bg-black hover:text-white text-black font-bold px-4 sm:px-6 py-2 rounded-lg mt-4 sm:mt-10 text-sm sm:text-base">
            Shop Now ➜
          </button>
        </div>
